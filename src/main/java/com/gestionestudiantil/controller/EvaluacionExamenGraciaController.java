...
@ManagedBean
@ViewScoped
public class EvaluacionExamenGraciaController implements Serializable {

	private static final long serialVersionUID = 2028162589425565453L;
	...
	private List<EvaluacionAsignatura> detallesInformesAnuales;
	...
	@PostConstruct
	public void init() {
		detallesInformesAnuales = evaluacionService.obtenerDetallesInformesAnualesGraciaPorAsignatura(asignatura);
		esPrincipal = asignatura.getAsignaturas().size() > 0;
		gruposDeEvaluacion = evaluacionService.obtenerGruposDeEvaluacionActivos(periodoLectivo);
	}
	...
	public String seleccionarGrupoDeEvaluacion() {
		facesContext.getExternalContext().getSessionMap().put("matricula", matricula);
		return "/evaluacion/" + grupoDeEvaluacion.getUrl() + "?faces-redirect=true";
	}
	...
	public List<EvaluacionAsignatura> getDetallesInformesAnuales() {
		return detallesInformesAnuales;
	}

	public void setDetallesInformesAnuales(List<EvaluacionAsignatura> detallesInformesAnuales) {
		this.detallesInformesAnuales = detallesInformesAnuales;
	}
	...
	public void setEvaluacionAsignatura(EvaluacionAsignatura evaluacionAsignatura) {
