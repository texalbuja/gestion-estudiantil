...
@ManagedBean
@ViewScoped
public class GrupoDeEvaluacionComportamientoController implements Serializable {
	...
	public void init() {
		gruposDeEvaluacion = evaluacionService
				.obtenerGruposDeEvaluacionDeComportamientoActivos(periodoLectivo);
	}

	public String seleccionarGrupoDeEvaluacion() {
		facesContext.getExternalContext().getSessionMap()
				.put("grupoDeEvaluacion", grupoDeEvaluacion);
		return "/comportamiento/" + grupoDeEvaluacion.getUrl()
				+ "?faces-redirect=true";
	}
