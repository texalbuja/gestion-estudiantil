...
@ManagedBean
@ViewScoped
public class EvaluacionExamenMejoramientoController implements Serializable {
	
	private static final long serialVersionUID = -6253137518253376236L;
	...
	@PostConstruct
	public void init() {
		detallesInformesAnuales = evaluacionService
				.obtenerDetallesInformesAnualesMejoramientoPorAsignatura(asignatura);
	...
	public void setDetallesInformesAnuales(
