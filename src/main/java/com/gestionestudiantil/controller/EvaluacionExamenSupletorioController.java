...
@ManagedBean
@ViewScoped
public class EvaluacionExamenSupletorioController implements Serializable {
	
	private static final long serialVersionUID = 291794074099888232L;
	...
	public void init() {
		detallesInformesAnuales = evaluacionService
				.obtenerDetallesInformesAnualesSupletoriosPorAsignatura(asignatura);
